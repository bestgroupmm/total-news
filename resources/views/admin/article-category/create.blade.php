   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_panel">
         ...
         <div class="x_content">
            ...
            <form class="form form-horizontal" method="POST" action="{{url('admin/article-categories')}}" enctype="multipart/form-data">
               {{csrf_field()}}
               ...
               <div class="form-group{{ $errors->has('keyword') ? ' has-error' : '' }}">
                  ...
                  <div class="col-md-6">
                     <input id="keyword" type="text" class="form-control" name="keyword" value="{{ old('keyword') }}">
