   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_panel">
         ...
         <div class="x_content">
            ...
            <form class="form form-horizontal" method="POST" action="{{url('admin/ads')}}" enctype="multipart/form-data">
               {{csrf_field()}}
                  ...
                  <div class="col-md-6">
                     <div class="row">
                       ...
                       <div class="form-group{{ $errors->has('start') ? ' has-error' : '' }} col-md-4">
                          ...
                          <div class="col-md-12">
                             <input id="start" type="text" class="form-control row" name="start" value="{{ old('start') }}" required>
                       ...
                       <div class="form-group{{ $errors->has('end') ? ' has-error' : '' }} col-md-4">
                          ...
                          <div class="col-md-12">
                             <input id="end" type="text" class="form-control row" name="end" value="{{ old('end') }}" required>
                       ...
                       <div class="form-group{{ $errors->has('duration') ? ' has-error' : '' }} col-md-4">
                          ...
                          <div class="col-md-12">
                             <input id="duration" type="text" class="form-control row" name="duration" value="{{ old('duration') }}" required>
