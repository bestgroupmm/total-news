...
<aside class="col-md-4 blog-sidebar">
  ...
  <div class="p-3">
    ...
    <div class="row mb-2 bg-light p-2 rounded card flex-md-row box-shadow">
        ...
        <div class="col-md-9">
          <h4 class="blog-post-title" style="font-size: 18px;" title="{{$article->title_en}}">{{$article->title}}</h4>
